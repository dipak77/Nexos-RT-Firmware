...
|---|---|---|
| VCC | **5V** | This module has an onboard regulator; 3V3 can light the backlight while undervolting the controller |
| GND | GND | |
| SCL | GPIO12 | SPI CLK |
| SDA | GPIO11 | SPI MOSI |
| DC | GPIO10 | |
| CS | GPIO9 | |
| RST | GPIO14 | |
| I2C SDA | GPIO16 | Expansion only; not the LCD SDA pin |
| I2C SCL | GPIO17 | Expansion only; not the LCD SCL pin |
...
## Troubleshooting
- No display: Use VCC=5V and check SPI wiring: CLK 12, MOSI 11, CS 9, DC 10, RST 14, 2MHz prototype clock
